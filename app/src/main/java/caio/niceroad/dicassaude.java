...
public class dicassaude extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dicassaude);
...
//edtValor = (EditText) findViewById(R.id.edtValor);
        ...
        btnFazer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(dicassaude.this, dicasambulancia.class);
        ...
        btnCognato.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent it = new Intent(dicassaude.this, dicaspressao.class);
                // it.putExtra("VALOR", edtValor.getText().toString());
                startActivity(it);
            }
        });
        ...
        btnPonto.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent it = new Intent(dicassaude.this, dicastonto.class);
                // it.putExtra("VALOR", edtValor.getText().toString());
                startActivity(it);
            }
        });
        ...
        btnDicas.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent it = new Intent(dicassaude.this, dicasmal.class);
                // it.putExtra("VALOR", edtValor.getText().toString());
                startActivity(it);
            }
        });
