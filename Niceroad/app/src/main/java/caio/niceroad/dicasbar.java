...
public class dicasbar extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dicasbar);

       final MediaPlayer barsound = MediaPlayer.create(this, R.raw.playbar);
        Button playbar = (Button) this.findViewById(R.id.play_bar);
