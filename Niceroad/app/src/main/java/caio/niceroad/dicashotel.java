...
public class dicashotel extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dicashotel);
        ...
        btnFazer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(dicashotel.this, dicasbar.class);
        ...
        btnCognato.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent it = new Intent(dicashotel.this, dicastaxi.class);
                // it.putExtra("VALOR", edtValor.getText().toString());
                startActivity(it);
            }
        });
        ...
        btnPonto.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent it = new Intent(dicashotel.this, dicasmalas.class);
                // it.putExtra("VALOR", edtValor.getText().toString());
                startActivity(it);
            }
        });
        ...
        btnDicas.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent it = new Intent(dicashotel.this, dicasquarto.class);
                // it.putExtra("VALOR", edtValor.getText().toString());
                startActivity(it);
            }
        });
