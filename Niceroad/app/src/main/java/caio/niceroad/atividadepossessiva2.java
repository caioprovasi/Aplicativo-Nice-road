...
public class atividadepossessiva2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_atividadepossessiva2);
        ...
        if (!clicou){
            ...
            Button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent it = new Intent(atividadepossessiva2.this, atividadepossessiva3.class);
